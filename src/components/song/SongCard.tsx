...
import { getSongReleaseRemainingDays } from '../../utils/dateCountdown'
...
export function SongCard({ song, onClick, displayMode = 'all' }: SongCardProps) {
  ...
  const remainingDays = getSongReleaseRemainingDays(song.releaseYear, song.releaseDate)
      ...
      >
        <div className="song-card__thumbnail-image">
          {thumbnailUrl ? (
            ...
            <div
              className={`song-card__thumbnail-placeholder song-card__thumbnail-placeholder--${embedService}`}
            >
        ...
        <div className="song-card__thumbnail-info">
          <div className="song-card__title-row">
            ...
            {remainingDays !== null && (
              <span className="song-card__countdown">残り{remainingDays}日</span>
            )}
          </div>
